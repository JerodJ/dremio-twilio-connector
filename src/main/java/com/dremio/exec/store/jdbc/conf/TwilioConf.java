...
@SourceType(value = "TwilioARP", label = "Twilio",uiConfig = "twilio-layout.json")
public class TwilioConf extends AbstractArpConf<TwilioConf> {
  private static final String ARP_FILENAME = "arp/implementation/twilio-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.twilio.TwilioDriver";
